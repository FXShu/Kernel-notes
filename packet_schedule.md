...
CBQ is abbreviation of `Classes Base Queue` which is abstract queueing-discipline contain packet delivery policies.<br>
Delivery policies define as `filter_list` in structure `cbq_class`, which consist by lots of difference filter such as `u32`, `flow`...<br>
see the chapter [filter](#filter_topic) for more information.<br>
```mermaid
	classDiagram
	class Qdisc {
...
```
#### Enqueue
The enqueue operation of `CBQ` is foreach the `filter_list`, search the match selector and execute the corresponding queueing-discipline's enqueue function.<br>
```c
...
static struct cbq_class *cbq_classify(struct sk_buff *skb, struct Qdisc *sch, int *qerr) {
	...
	for (;;) {
		fl = rcu_dereference_bh(nead->filter_list);
		 ...
		 *           Repeat this procdure util we hit a leaf node.
		 */
		head = cl;
	}
...
fallback:
	 ...
	 */
	if (TC_H_MAJ(prio) == 0 &&
		!(cl = head->default[prio & TC_PRIO_MAX]) &&
...
<details><summary>bpf</summary>
TODO
</details>
<details><summary>basic</summary>
TODO
</details>
<details><summary>cgroup</summary>
TODO
</details>
<details><summary>flow</summary>
TODO
</details>
<details><summary>flower</summary>
TODO
</details>
<details><summary>fw</summary>
TODO
</details>
<details><summary>matchall</summary>
TODO
</details>
<details><summary>route</summary>
TODO
</details>
<details><summary>rsvp</summary>
TODO
</details>
<details><summary>rsvp6</summary>
TODO
</details>
<details><summary>tcindex</summary>
TODO
</details>
...
```
#### Action
The action will be executed when the packet match correspnding selector rule if the kernel compile flag `CONFIG_NET_CLS_ACT` is enabled.<br>
TODO.
#### Filter_list
![u32_filter_list](./picture/packet_schedule/u32_filter_list.png)
```c
